...
- Keep tracking simple. If the action happens entirely in the browser with no server call, track it directly in the click handler or after the local state update.
